    ...
    int ist, int iend, int jst, int jend, int nx0, int ny0)
{
  ...
  copyin(d[:ISIZ1][:ISIZ1/2*2+1][:5][:5], vk[:ISIZ1][:ISIZ1/2*2+1][:5], ldy[:ISIZ1][:ISIZ1/2*2+1][:5][:5], ldx[:ISIZ1][:ISIZ1/2*2+1][:5][:5])
  ...
  #pragma acc exit data delete(tv[:ISIZ1][:5], tmat[:ISIZ1][:5][:5]) \
  copyout(d[:ISIZ1][:ISIZ1/2*2+1][:5][:5], vk[:ISIZ1][:ISIZ1/2*2+1][:5], ldy[:ISIZ1][:ISIZ1/2*2+1][:5][:5], ldx[:ISIZ1][:ISIZ1/2*2+1][:5][:5])
  printf("END\n");
