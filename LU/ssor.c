...
void ssor(int niter)
{
  ...
  for (istep = 1; istep <= niter; istep++) {
    ...
    //#pragma omp barrier
    # pragma acc data copyin(u[:ISIZ3][:ISIZ2/2*2+1][:ISIZ1/2*2+1]:[5], rsd[:ISIZ3][:ISIZ2/2*2+1][:ISIZ1/2*2+1][:5], frct[:ISIZ3][:ISIZ2/2*2+1][:ISIZ1/2*2+1][:5], \
	flux [:ISIZ1][:5], qs[:ISIZ3][:ISIZ2/2*2+1][:ISIZ1/2*2+1], rho_i[:ISIZ3][:ISIZ2/2*2+1][:ISIZ1/2*2+1], \
	a[:ISIZ2][:ISIZ1/2*2+1][:5][:5], b[:ISIZ2][:ISIZ1/2*2+1][:5][:5], c[:ISIZ2][:ISIZ1/2*2+1][:5][:5],d[:ISIZ2][:ISIZ1/2*2+1][:5][:5], \
	au[:ISIZ2][:ISIZ1/2*2+1][:5][:5], bu[:ISIZ2][:ISIZ1/2*2+1][:5][:5], cu[:ISIZ2][:ISIZ1/2*2+1][:5][:5],du[:ISIZ2][:ISIZ1/2*2+1][:5][:5])
    for (k = 1; k < nz -1; k++) {
      //---------------------------------------------------------------------
    ...
    # pragma acc data copyout(u[:ISIZ3][:ISIZ2/2*2+1][:ISIZ1/2*2+1]:[5], rsd[:ISIZ3][:ISIZ2/2*2+1][:ISIZ1/2*2+1][:5], frct[:ISIZ3][:ISIZ2/2*2+1][:ISIZ1/2*2+1][:5], \
	flux [:ISIZ1][:5], qs[:ISIZ3][:ISIZ2/2*2+1][:ISIZ1/2*2+1], rho_i[:ISIZ3][:ISIZ2/2*2+1][:ISIZ1/2*2+1], \
	a[:ISIZ2][:ISIZ1/2*2+1][:5][:5], b[:ISIZ2][:ISIZ1/2*2+1][:5][:5], c[:ISIZ2][:ISIZ1/2*2+1][:5][:5],d[:ISIZ2][:ISIZ1/2*2+1][:5][:5], \
	au[:ISIZ2][:ISIZ1/2*2+1][:5][:5], bu[:ISIZ2][:ISIZ1/2*2+1][:5][:5], cu[:ISIZ2][:ISIZ1/2*2+1][:5][:5],du[:ISIZ2][:ISIZ1/2*2+1][:5][:5])
